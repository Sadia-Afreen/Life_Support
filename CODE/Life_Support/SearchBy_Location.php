...
<div class="wrapper">
    ...
    <div class="form_loc">
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <label for="division">Choose Division:</label><br><br>
...
*/
    if (empty($_POST["area"])) {
        $sql = "SELECT * FROM `donor` WHERE D_Division='$division'";
        $result = mysqli_query($conn, $sql);
        $flag2 = 1;
    }

    if ((!empty($_POST["division"])) && (!empty($_POST["area"]))) {
        $sql = "SELECT * FROM `donor` WHERE D_Division='$division' AND D_Area='$area'";
